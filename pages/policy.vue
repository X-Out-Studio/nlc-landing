<template>
  <div class="policy">
    ...
    <p class="policy__subtitle">1. Общие положения</p>
    <p class="policy__text">
      ...
      предпринимаемые Next Level Car (далее — Оператор).
      <br />
      <br />
      ...
      веб-сайта <a href="/">https://nextlevelcar.ru/.</a> <br />
    </p>
    ...
    <p class="policy__text">
      ...
      <a href="/">https://nextlevelcar.ru/.</a><br />
      ...
      веб-сайта https://nextlevelcar.ru/.<br />
      ...
      для распространения).<br />2.10. Пользователь — любой посетитель
      веб-сайта https://nextlevelcar.ru/.<br />
    ...
    <p class="policy__text">
      ...
      информацию и/или документы, содержащие персональные данные;<br />
      ...
      Закона о персональных данных;<br />
    ...
    <p class="policy__text">
      ...
      порядок ее получения установлен Законом о персональных
      данных;<br />
    ...
    <p class="policy__text">
      ...
      защиты персональных данных.<br /><br />
      ...
      Оператора nlc-auto@yandex.ru с пометкой «Актуализация
      персональных данных».<br />
      ...
      nlc-auto@yandex.ru с пометкой «Отзыв согласия на обработку
      персональных данных».<br />
      ...
      хранения персональных данных не установлен федеральным законом,
      договором, стороной которого, выгодоприобретателем или
      поручителем по которому является субъект персональных данных.<br />
    ...
    <p class="policy__subtitle">12. Заключительные положения</p>
    <p class="policy__text">
      ...
      <a href="mailto:nlc-auto@yandex.ru ">nlc-auto@yandex.ru.</a
      ><br />
