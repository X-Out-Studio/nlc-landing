    ...
    <form class="footer__form">
      <div class="container">
        <div class="footer__data">
          <input class="footer__form-input" placeholder="Ваше имя" />
      ...
      <div class="container">
        <div class="footer__contact">
          <a class="footer__phone" href="tel:+71234567890"
            >Телефон +7&nbsp;123&nbsp;456&nbsp;78&nbsp;90</a
          >
          <a
            class="footer__email"
            href="mailto:ask@htmlbook.ru?subject=Вопрос по HTML"
            >Почта pochta@gmail.com</a
          >
        </div>
      ...
      <div class="container">
        <div class="footer__rule">
          <p class="footer__regulation">
            Любое использование или копирование материалов или сборки материалов
            сайта, элементов дизайна и оформления допускается только с
            разрешения правообладателя и только со ссылкой на источник:
            <a href="#">https://8stories.team</a>
          </p>
