...
const changeState = (param) => {
  store.answers.firstStepBU = param;
};
let active = ref(null);
  ...
  <div>
    <div class="calc-container">
      ...
      <div class="navigate-container">
        <svg @click="store.answers.firstStepBUWaiting = false" width="67" height="67" viewBox="0 0 67 67" fill="none"
