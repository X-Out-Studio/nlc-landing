  ...
  <div>
    <div class="calc-container">
      <div class="title-container">
        <div class="name">напишите модель автомобиля</div>
        <div class="page">02<span>/08</span></div>
      </div>
      <div class="select-container">
        <div class="select-row">
          <input type="text" class="wishes-input" v-model="store.answers.secondStepOther"
            placeholder="Напишите какую модель автомобиля вы хотите" />
        </div>
      </div>
      <div class="navigate-container">
        <svg @click="store.answers.secondStepOtherWaiting = false" width="67" height="67" viewBox="0 0 67 67" fill="none"
