        ...
        <Transition>
          <div v-if="!finishForm" class="modal__start">
            ...
            <form class="modal__form">
              <input class="modal__input" v-model="store.name" type="text" :class="errorActive ? 'error' : ''"
                placeholder="Ваше имя" />
              <input class="modal__input" v-model="store.phone" type="tel"
                :class="[errorActive ? 'error' : '', errorPhone ? 'error-phone' : '']" placeholder="+7..." v-maska
                data-maska="+7 ### ###-##-##" />
            </form>
